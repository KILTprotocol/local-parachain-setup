...
const wasmPath = path.join(__dirname, './', 'kilt.wasm');
const genesisPath = path.join(__dirname, './', 'kilt-genesis.hex');
const relayProvider = process.env.RELAY_WS_ENDPOINT || 'ws://127.0.0.1:40044'
